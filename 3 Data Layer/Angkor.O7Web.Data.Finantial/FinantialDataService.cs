...
namespace Angkor.O7Web.Data.Finantial
{
    public class FinantialDataService : O7AbstractData
    {
        ...
        public virtual string AddInvoice(string companyId, string branchId, 
                                       ...
                                       string serieExtRef,string nroExtRef)
        {
            ...
            return DataAccess.ExecuteFunction<string>("finantial_invoice.insert_cab_factura", parameters);
        }
