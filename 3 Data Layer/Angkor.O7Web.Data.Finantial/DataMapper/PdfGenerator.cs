...
namespace Angkor.O7Web.Interface.Finantial.Controller
{
    ...
    class PdfGenerator
    {
        ...
        public Dictionary<string,string> convertToDictonary(DetailInvoicePDF concept)
        {
        ...
        public static void generar(HeadInvoicePDF head,List<DetailInvoicePDF> details,string pathFile)
        {
